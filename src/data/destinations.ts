...
const REGION_SPOTLIGHTS: Record<string, Record<string, string[]>> = {
  ...
  okinawa: { 潜水: ["庆良间群岛", "青之洞窟"], 海岛: ["宫古岛", "石垣岛", "西表岛", "竹富岛"], 亲子: ["美丽海水族馆", "古宇利岛"] },
...
const SPOT_COORDINATES: Record<string, [number, number]> = {
  ...
  西表岛: [24.332, 123.805], 竹富岛: [24.327, 124.089], 与那国岛: [24.469, 123.005], 久米岛: [26.361, 126.774], 座间味岛: [26.229, 127.303], 波照间岛: [24.059, 123.779],
