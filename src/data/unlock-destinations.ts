...
const profiles: Record<string, Omit<UnlockDestinationProfile, "key">> = {
  ...
  "JPN:kinki": { name: "近畿地方", english: "Kinki (Kansai)", code: "JP", focus: [34.8, 135.5], continent: "亚洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "CHE:alpine-ch": { name: "瑞士阿尔卑斯", english: "Swiss Alps", code: "CH", focus: [46.6, 8.0], continent: "欧洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "NOR:west-no": { name: "挪威西部峡湾", english: "Western Fjords", code: "NO", focus: [61.1, 6.8], continent: "欧洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "IDN:bali-nt": { name: "巴厘与努沙登加拉", english: "Bali & Nusa Tenggara", code: "ID", focus: [-8.5, 117.0], continent: "亚洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "CHN:northwest": { name: "西北地区", english: "Northwest China", code: "CN", focus: [40.0, 95.0], continent: "亚洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "ITA:central-italy": { name: "意大利中部", english: "Central Italy", code: "IT", focus: [42.9, 12.5], continent: "欧洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "USA:west": { name: "美国西部", english: "US West", code: "US", focus: [37.2, -119.0], continent: "北美", verifiedAt: "2026-07-15", tasks: [
  ...
  "USA:mountain-us": { name: "美国山地区", english: "Mountain West", code: "US", focus: [40.5, -111.0], continent: "北美", verifiedAt: "2026-07-15", tasks: [
  ...
  "CAN:west-ca": { name: "加拿大西部", english: "Western Canada", code: "CA", focus: [51.0, -116.5], continent: "北美", verifiedAt: "2026-07-15", tasks: [
  ...
  "THA:south-th": { name: "泰国南部", english: "Southern Thailand", code: "TH", focus: [8.1, 98.4], continent: "亚洲", verifiedAt: "2026-07-15", tasks: [
  ...
  "AUS:qld": { name: "昆士兰", english: "Queensland", code: "AU", focus: [-18.2, 146.2], continent: "大洋洲", verifiedAt: "2026-07-15", tasks: [
